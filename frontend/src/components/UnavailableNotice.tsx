  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      try {
        ...
        /* Readiness being unreachable is not worth a second error message:
           the caller already handed us one to show, and an unreachable
           backend is exactly what that one is about. */
      }
    };
